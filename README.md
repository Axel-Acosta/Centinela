...
- The public web surface now includes a concrete public risk-story model: Paraguay country story, buyer/institution search, company search, company/institution profiles, and `review intensity` labels. Review intensity is a triage label, not a corruption score.
