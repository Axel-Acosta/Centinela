...
- Phase D - Public/product publication layer: about 28-34% is done.
- Overall long-term product: about 47-57% done, because the internal evidence spine is strong and the local product surface now has graph, artifact, queue, readiness, case-packet, and source-index exploration, but the public product and more cross-domain Paraguay sources are still early.
...
- Add a clearer public-methodology/limitations area inside the local interface, derived from the existing docs and gates.
- Tighten the entity-to-case/source-pack handoff so opening a dossier, source pack, case packet, artifact, and source record feels like one connected workflow.
...
- First presentable local/internal product surface: first meaningful slice plus graph/artifact/readiness and case-packet/source-index slices achieved; likely 1-2 more focused interface runs before it feels like a strong internal MVP.
