...
27. Next best product-interface move:
   add a clearer public-methodology/limitations area inside the local interface, tighten dossier-to-case/source-pack navigation, and add safer artifact/source verification affordances before returning to broad Paraguay source expansion.
28. Treat the 2026-05-12 Command Center as the first presentable local/internal product surface:
   it is strong enough to show the platform concept internally, now includes graph/artifact/readiness exploration, case review packets, and source-document match previews, but it is not a public launch surface and still needs production auth, privacy review, public-safe copy, and methodology pages before any public exposure.
