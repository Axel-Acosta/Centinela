...
- Next expansion: improve the local candidate scoring/evidence model, add a lightweight recent-artifact registry or reader for generated case bundles/indexes, then add ownership/foreign-company/offshore edges on top of the DNCP plus DNIT company master.
